...
export function StressFreeCare() {
    return (
        <section className="pb-12 sm:pb-16 md:pb-20 relative bg-[#eaf6f9] overflow-hidden">
            <div className="container mx-auto px-5 sm:px-6 lg:px-6 xl:px-8 max-w-[800px] relative z-10 text-center">
                <p className="text-[15px] sm:text-[16px] md:text-[17px] text-[#333333] leading-[1.65] mb-6">
                ...
                <p className="text-[15px] sm:text-[16px] md:text-[17px] text-[#333333] leading-[1.65] mb-10">
