            ...
            <div className="container mx-auto px-4 lg:px-6 xl:px-8 max-w-[1200px]">
                ...
                <div className="flex flex-col md:flex-row gap-12 lg:gap-16 items-start">
                    <div className="w-full md:w-[48%]">
                        <h2 className="text-[26px] md:text-[32px] font-bold text-[#043b67] mb-6 font-sans tracking-tight leading-[1.2]">
                            Providing Personalized In-Home Care Solutions
                        </h2>
                        <p className="text-[15px] text-[#333333] leading-[1.65] mb-5">
                        ...
                        <p className="text-[15px] text-[#333333] leading-[1.65]">
                    ...
                    <div className="w-full md:w-[52%] relative">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="relative h-[240px] sm:h-[280px] rounded-[8px] overflow-hidden shadow-md">
                                <Image
                            ...
                            <div className="relative h-[200px] sm:h-[240px] rounded-[8px] overflow-hidden shadow-md sm:col-span-2">
                                <Image
