...
export function InnerPageSidebar() {
    ...
    return (
        <div className="w-full">
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <Link
                            key={item.label}
                            href={item.href}
                            className={`flex items-center justify-between px-6 py-4 font-bold text-[15px] transition-colors rounded-[3px] shadow-sm ${
                                isActive
                        ...
                        >
                            ...
                            <span className={isActive ? "text-[#5cb3b1]" : "text-[#3b7ea1] opacity-70"}>
                                →
                            </span>
                        </Link>
                    );
            ...
            <div className="bg-[#eaf6f9] p-6 rounded-[3px]">
